...
ActiveRecord::Schema.define(version: 20200403161352) do
  ...
  create_table "ride_mechanics", force: :cascade do |t|
    ...
    t.index ["ride_id"], name: "index_ride_mechanic_on_ride_id"
  end
  ...
  add_foreign_key "ride_mechanics", "mechanics", column: "mechanic_id"
